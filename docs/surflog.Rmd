...
![Figure 5. Predicted number of rides on five randomly selected surf days. The lines represent the predictions, and the single large point on each panel represents the observed number of rides. Predictions of zero rides have been omitted for clarity.](../figs/predict_session_random.png)
...
![Figure 6. Observed number of rides plotted against the predicted number of rides. ](../figs/obs_pred_ride_count.png)
