...
As an example, I used an example dataset with 86 records of surf sessions over three years in Monterey, California to represent a central California surfer. Below, I plot the monthly number of surf sessions:
...
![](../figs/plot_lm_effects_ridecount.png)
